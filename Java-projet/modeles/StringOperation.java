 ...
 * 
 * @see <a href=
 *      "https://java.developpez.com/sources/?page=nombresDatesString#supprimmerAccents">Developpez.com</a>
 **/
public abstract class StringOperation {
	...
	/**
	 * Initialisation du tableau de correspondance entre les caractéres accentués et
	 * leur homologues non accentués
	 * 
	 * @return Vecteur de correspondance entre accent / sans accent
	 */
